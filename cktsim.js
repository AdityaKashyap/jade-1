        ...
        try {
            ...
            if ((this.diddc === false) && (no_dc === false)) {
                if (this.dc() === undefined) { // DC failed, realloc mats and vects.
                    ...
                    if (this.finalize() === false) progress.finish(undefined, progress); // nothing more to do
            ...
            for (var name in this.node_map) {
                var index = this.node_map[name];
                for (i = progress.probe_names.length; i >= 0; i -= 1) {
            ...
            if (t >= tupdate) {
                ...
                setTimeout(function() {
                    try {
                        ...
                        if (typeof e == 'string') ckt.progress.finish(e, ckt.progress);
                        else throw e;
                    }
                }, 1);
